...
<footer class="ftco-footer ftco-bg-dark ftco-section">
      <div class="container">
        <div class="row mb-5">
          <div class="col-md">
            <div class="ftco-footer-widget mb-4">
              <h2 class="logo"><a href="#">My<span>Blog</span>.</a></h2>
          ...
          <div class="col-md">
            <div class="ftco-footer-widget mb-4">
              ...
              <div class="block-23 mb-3">
                <ul>
                  <li><span class="icon icon-map-marker"></span><span class="text">Gaza, Palestain</span></li>
                  <li><a href="#"><span class="icon icon-phone"></span><span class="text">+972592457262</span></a></li>
                  <li><a href="#"><span class="icon icon-envelope"></span><span class="text">areejalzarqa@gmail.com</span></a></li>
                </ul>
              </div>
            </div>
          </div>
        ...
        <div class="row">
          ...
          Copyright &copy;<script>document.write(new Date().getFullYear());</script>  made with <i class="icon-heart color-danger" aria-hidden="true"></i> by Areej Alza</a>
